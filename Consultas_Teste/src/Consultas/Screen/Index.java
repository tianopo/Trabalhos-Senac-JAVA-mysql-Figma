...
public class Index extends javax.swing.JFrame {
    ...
    private final List<Lista> alunosList = new ArrayList<>();
    
    protected void inserirAluno(Lista aluno){
    ...
    private void atualizarTabela(){
        if(!alunosList.isEmpty()){
            ...
            for(int i = 0; i < alunosList.size(); i++){
                ...
                String[] rowData = {aluno.getNome(), aluno.getCpf(),
                    aluno.getTelefone(), aluno.getData(), "sim", "não"
                };
